...
(function () {
  ...
  const fixtures = {
    ...
    magna: {
      ...
      semesters: [
        sem('2324', 'First', [
          sub('GEED 004', 'Purposive Communication', '3.0', 1.5),
        ...
        sem('2324', 'Second', [
          ...
          sub('GEED 002', 'Readings in Philippine History', '3.0', 1.5),
        ...
        sem('2425', 'First', [
          ...
          sub('MATH 010', 'Discrete Mathematics', '3.0', 1.75),
          sub('CWTS 002', 'Civic Welfare Training Service 2', '3.0', 1.0)
        ]),
        sem('2425', 'Second', [
          sub('INTE 202', 'Integrative Programming 1', '3.0', 1.25),
          sub('COMP 010', 'Data Structures', '3.0', 1.5),
          sub('PATHFIT 4', 'Physical Activity Towards Health and Fitness 4', '2.0', 1.0)
        ])
      ]
    },
    ...
    cum: {
      ...
      semesters: [
        sem('2425', 'First', [
          sub('GEED 001', 'Understanding the Self', '3.0', 1.75),
    ...
    lost: {
      ...
      semesters: [
        ...
        sem('2425', 'Second', [
          ...
          sub('INTE 202', 'Integrative Programming 1', '3.0', 2.25, '2.25'),
          sub('PATHFIT 4', 'Physical Activity Towards Health and Fitness 4', '2.0', 1.0)
        ])
      ]
    },
    ...
    foolsGold: {
      ...
      semesters: [
        ...
        sem('2425', 'Second', [
          sub('COMP 009', 'Object Oriented Programming', '3.0', 1.0),
          sub('INTE 202', 'Integrative Programming 1', '1.0', 2.25, '2.25'),
          sub('PATHFIT 4', 'Physical Activity Towards Health and Fitness 4', '2.0', 1.0)
        ])
      ]
    },
